...
See the [application README](protein-ipad/README.md) for usage, testing, and serving a production build. `v1.0.0` preserves the first version successfully tested on iPad; the current working version is 1.3.0.
