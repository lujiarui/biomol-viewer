...
Load and align two files, select a residue, and request Nearby atoms. Confirm both files contribute side chains. Hide a counterpart chain, request Nearby again, and confirm it is excluded. Check the language pill at narrow widths and the empty-screen scenario shortcut.
